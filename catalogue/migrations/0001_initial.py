# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-11-07 10:58
from __future__ import unicode_literals

import core.validators
import core_models.fields
import core_models.fields.autoslugfield
import core_models.fields.slugfield
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', core_models.fields.slugfield.SlugField(max_length=255, verbose_name='Slug')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upc', core_models.fields.NullCharField(help_text='Universal Product Code (UPC) is an identifier for a product which is not specific to a particular  supplier. Eg an ISBN for a book.', max_length=64, unique=True, verbose_name='UPC')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('text', 'Text'), ('integer', 'Integer'), ('boolean', 'True / False'), ('float', 'Float'), ('richtext', 'Rich Text'), ('date', 'Date'), ('option', 'Option'), ('entity', 'Entity'), ('file', 'File'), ('image', 'Image')], default='text', max_length=20, verbose_name='Type')),
                ('required', models.BooleanField(default=False, verbose_name='Required')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='attributes', to='catalogue.Category')),
