...
class StockRecord(models.Model):
    ...
    date_updated = models.DateTimeField(_("Date updated"), auto_now=True,
                                        db_index=True)
    is_our_storage = models.BooleanField('Остатки с нашего склада?', default=False)
    not_delete_stock = models.BooleanField('Оставить эти остатки(при выгрузке)?', default=False)
...
class StockAlert(models.Model):
    ...
    class Meta:
        ...
        verbose_name = _('Складская запись')
        verbose_name_plural = _('Складские записи')
