...
class UseAllStockRecord(object):
    def select_stockrecord(self, product):
        return product.stockrecords.filter(num_in_stock__gt=0)[0]
...
class CustomDefault(UseAllStockRecord, StockRequired, NoTax, Structured):
    """
